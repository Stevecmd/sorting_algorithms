...
stevecmd@DESKTOP-UTB295U:~/sorting_algorithms$ cat 2-main.c
#include <stdio.h>
#include <stdlib.h>
#include "sort.h"
...
stevecmd@DESKTOP-UTB295U:~/sorting_algorithms$ gcc -Wall -Wextra -Werror -pedantic  -std=gnu89 2-main.c 2-selection_sort.c print_array.c -o select
stevecmd@DESKTOP-UTB295U:~/sorting_algorithms$ ./select
19, 48, 99, 71, 13, 52, 96, 73, 86, 7
